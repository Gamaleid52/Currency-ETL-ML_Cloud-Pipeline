...
# ==========================================
# 🛠️ DATABASE CONNECTION SETTINGS (CLOUD SECRETS)
# ==========================================
# 🛠️ DATABASE CONNECTION SETTINGS (CLOUD POOLER)
# ==========================================
if "supabase" in st.secrets:
    raw_password = st.secrets["supabase"]["password"]
    
# التعديل السحري: استخدام الـ Connection Pooler (المستقر سحابياً) وبورت 6543
# وتغيير الهوست إلى النمط البديل اللي Supabase بتنصح بيه للـ Serverless Applications
# ==========================================
# السيرفر هيقرا الباسورد من الإعدادات السحابية مباشرة الآن بأمان وبدون مشاكل رموز
if "supabase" in st.secrets:
    raw_password = st.secrets["supabase"]["password"]
else:
...
connection_string = f"postgresql+psycopg2://postgres.wzxaotzomwlkrudvmpwy:{encoded_password}@aws-0-eu-central-1.pooler.supabase.com:6543/postgres?sslmode=require"
